 ...
 * Writes to furina.log for current day; rotates to furina-YYYY-MM-DD.log on next-day startup.
 ...
 * Renames furina.log to furina-YYYY-MM-DD.log (using the file's last-modified date).
 */
 ...
 * Active log is written to furina.log; previous-day logs are rotated on startup.

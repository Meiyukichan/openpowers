...
2. **Create the change directory**
   ...
   This creates the change at `furina/changes/<name>/` and brings it into the Furina change management system.
...
4. **Create artifacts in strict order as follows until ready**
   ...
   - Get instructions:
     ```bash
     furina change instruction <name> --<artifact-id>
     ```
   ...
   - After creating each artifact in `step a`, re-run `furina change status <name>`
...
- What's ready and Remind the user: "All artifacts created! You can run skill `furina-plan` to generate schema docs and make work plan."

**Artifact Creation Guidelines**

- Follow the `instruction` field from `furina instructions` for each artifact type

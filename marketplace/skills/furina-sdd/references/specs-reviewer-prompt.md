...
Dispatch the `Spec Review Subagent` strictly according to the following parameter format (`Furina:review:Purpose` is the critical description marker of `Spec Review Subagent`, do NOT mistake it):
...
Agent tool (general-purpose):
  ...
  prompt: |
    ...
    **Description:** {feature.description}
    ...
    1. Read the spec review template document: `${CLAUDE_PLUGIN_ROOT}/skills/furina-sdd/references/specs-reviewer.md`

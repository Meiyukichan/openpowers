...
Dispatch the `Implementer Subagent` strictly according to the following parameter format (`Furina:coding:Purpose` is the critical description marker of `Implementer subagent`, do NOT mistake it):
...
Agent tool (general-purpose):
  ...
  prompt: |
    ...
    **Description:** {feature.description}
    ...
    {`{cwd}/furina/changes/<name>/reference/{feature-id}.md`}

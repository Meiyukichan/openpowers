...
Dispatch the `Code Quality Review Subagent` strictly according to the following parameter format (`Furina:review:Purpose` is the critical description marker of `Code Quality Review Subagent`, do NOT mistake it):
...
Agent tool (general-purpose):
  ...
  prompt: |
    ...
    **Description:** {feature.description}
    ...
    1. Read the code quality review template document: `${CLAUDE_PLUGIN_ROOT}/skills/furina-sdd/references/quality-reviewer.md`

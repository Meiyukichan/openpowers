...
**First principle:** the generated plan MUST NOT contain more than `experimental.factor` × (number of spec files in `openpowers/changes/<name>/specs/`(minimum: 1)) features.

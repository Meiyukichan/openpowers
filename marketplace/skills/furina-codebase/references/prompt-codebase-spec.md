...
Agent tool (general-purpose):
  ...
  prompt: |
    ...
    1. You **MUST** read `${CLAUDE_PLUGIN_ROOT}/skills/furina-codebase/references/guidance-codebase.md`, and then comprehensively understand the concepts, constraints, and content requirements of **Spec Document**. 
    2. Strictly and accurately following the requirements and steps of `${CLAUDE_PLUGIN_ROOT}/skills/furina-codebase/references/guidance-specs.md` to generate spec document for {spec name}.

...
Agent tool (general-purpose):
  ...
  prompt: |
    ...
    1. You **MUST** read `${CLAUDE_PLUGIN_ROOT}/skills/furina-codebase/references/guidance-codebase.md`, and then comprehensively understand the concepts, constraints, and content requirements of **Submodule**.

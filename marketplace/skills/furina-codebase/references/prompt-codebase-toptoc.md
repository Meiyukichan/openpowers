...
Agent tool (general-purpose):
  ...
  prompt: |
    ...
    1. You **MUST** read `${CLAUDE_PLUGIN_ROOT}/skills/furina-codebase/references/guidance-codebase.md`, and then comprehensively understand the concepts, constraints, and content requirements of **Module Index File**.
    ...
    4. Carefully generate the initial version of `{codebaseDir}/toc.md` using Top Toc template: `${CLAUDE_PLUGIN_ROOT}/skills/furina-codebase/references/template-top-toc.md`
```

...
Strictly follow the template: `${CLAUDE_PLUGIN_ROOT}/skills/openpowers-sdd/references/reference-explorer-prompt.md`, to dispatch the `reference explorer subagent`.

#### Dispatch Implementer Subagent

Strictly follow the template: `${CLAUDE_PLUGIN_ROOT}/skills/openpowers-sdd/references/code-implementer-prompt.md`, to dispatch the `implementer subagent`.

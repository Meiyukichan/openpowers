...
| --------------- | ------------------------------------------------------------------------------- |
| `cleancode`     | `${CLAUDE_PLUGIN_ROOT}/skills/openpowers-explore/instructions/cleancode.md`     |
| `codebase`      | `${CLAUDE_PLUGIN_ROOT}/skills/openpowers-explore/instructions/codebase.md`      |
| `repository`    | `${CLAUDE_PLUGIN_ROOT}/skills/openpowers-explore/instructions/repository.md`    |
| `reference`     | `${CLAUDE_PLUGIN_ROOT}/skills/openpowers-explore/instructions/reference.md`     |
| `memory`        | `${CLAUDE_PLUGIN_ROOT}/skills/openpowers-explore/instructions/memory.md`        |
| `specification` | `${CLAUDE_PLUGIN_ROOT}/skills/openpowers-explore/instructions/specification.md` |

## RED LAW

- Forbid openpowers-explore to read `Instruction Documents` before dispatching the subagent. The subagent will read the instruction documents.
- The openpowers-explore is forbidden from reading any documents, especially the `Instruction Documents`.

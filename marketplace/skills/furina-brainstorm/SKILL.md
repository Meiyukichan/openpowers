...
- Check `furina/changes/<name>/exploration.md` first — it may already contain the context you need, dig deeper into the code if it doesn't
...
You have full context of the Furina system. Use it naturally, don't force it.
...
1. **Read exploration.md first**
   - `furina/changes/<name>/exploration.md`

   This file contains prior exploration context. Read it before doing anything else to understand existing background. **If exploration.md does not exist, stop executing this skill and remind the user to run skill: furina-explore first.** If it's not sufficient, naturally supplement with further exploration.

2. **Read other existing artifacts for context**
   - `furina/changes/<name>/proposal.md`
   - `furina/changes/<name>/design.md`
   - `furina/changes/<name>/specs/**/*.md`
   - etc.
...
```
User: /furina-brainstorm add-auth-system
...
- **Flow into a proposal**: "Ready to start? I can create a change proposal." (optional: skill furina-propose)

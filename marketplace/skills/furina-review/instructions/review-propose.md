...
1. Review all proposal artifacts under the furina change directory
...
1. `furina/changes/<name>/proposal.md` — Proposal: what to do & why
2. `furina/changes/<name>/design.md` — Design: how to do it, technical approach
3. `furina/changes/<name>/specs/**/*.md` — Detailed specifications for each functional module
